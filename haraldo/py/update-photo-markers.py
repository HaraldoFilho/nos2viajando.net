...
command = "sed -e 's/locations_dict/locations_dict_' /home/pi/github/nos2viajando.net/haraldo/data/photos.js_ > /home/pi/github/nos2viajando.net/haraldo/data/photos.js"
os.system(command)
